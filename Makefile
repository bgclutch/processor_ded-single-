...
SOURCES = ../processor_cpps/main.cpp ../processor_cpps/processor.cpp ../lib_buffer_proc/buffer.cpp ../lib_file_proc/file.cpp
...
clean:
	rm -rf *.o $(EXECUTABLE)
# here rm -rf remove directories *.o in EXECUTABLE and content in them and ignore non-existing files
#equals to rm -r -f